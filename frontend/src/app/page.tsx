          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold py-6 px-12 rounded-2xl text-xl shadow-2xl hover:shadow-3xl transition-all duration-300 w-full sm:w-auto"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white hover:bg-gray-50 text-gray-900 font-bold py-6 px-12 rounded-2xl text-xl border-4 border-pink-200 hover:border-pink-300 shadow-xl hover:shadow-2xl transition-all duration-300 w-full sm:w-auto"
              >
